    ...
    public static function createSingleShipmentSuccess(): array
    {
        ...
        return array_map(
            function (AbstractRequestData $requestData) use ($requestBuilder) {
                return $requestData->createShipmentOrder($requestBuilder, self::REQUEST_TYPE);
            },
            [new Domestic()]
        );
    }
    ...
    public static function createSingleShipmentError(): array
    {
        ...
        return array_map(
            function (AbstractRequestData $requestData) use ($requestBuilder) {
                ...
                return $requestData->createShipmentOrder($requestBuilder, self::REQUEST_TYPE, $replace);
            },
            [new Domestic()]
        );
    }
